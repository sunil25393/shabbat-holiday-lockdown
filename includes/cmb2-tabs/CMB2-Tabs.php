    ...
    class CMB2_Tabs {
        ...
        public function render_nav($cmb_id, $object_id, $object_type, $cmb) 
        {
            ...
            if ($tabs) {
                ...
                echo ' <h2 class="nav-tab-wrapper cmb-tab-nav">';
                $active_nav = true;
                ...
                foreach ($tabs as $key => $tab_data)
                {
                        ...
                        $tab_data['icon'] = $tab_data['icon'] ? $tab_data['icon'] : "";
                        ...
                        printf(
                            '<div class="%s" data-panel="%s"><a href="#">%s<span>%s</span></a></div>',
                            $class,
                            $key,
                            $icon,
                            $tab_data['label']
            ...
            echo '<div class="', esc_attr($cmb->box_classes()), '"><div id="cmb2-metabox-', sanitize_html_class($cmb_id), '" class="cmb2-metabox cmb-field-list">';
                ...
                {   
                    if (!in_array($tab, $this->conditional, TRUE)) {
                            ...
                            echo '<div class="'.$active_panel.' cmb2-metabox  cmb-tab-panel cmb-tab-panel-'.$tab.'">';
                            echo implode('', $fields);
                            echo '</div>';
                    }
                }
