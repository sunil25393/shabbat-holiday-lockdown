...
function yourprefix_register_demo_metabox() {
    ...
    $cmb_demo->add_field(array(
        ...
        'desc' => sprintf(
                ...
                esc_html__('Enter a youtube, twitter, or instagram URL. Supports services listed at %s.', 'cmb2'), '<a href="https://wordpress.org/support/article/embeds/">codex.wordpress.org/Embeds</a>'
        ),
